...
let titleAs = document.querySelector("#title") as Element; // 왼쪽에 있는 요소를 Element type으로 간주해주세요~
...
let titleOption = document.querySelector("#title");
if (titleOption?.innerHTML != undefined) {
